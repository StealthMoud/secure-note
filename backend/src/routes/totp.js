...
router.get('/setup', async (req, res) => {
    try {
        ...
        // genrate new totp secret with 20 charactr length
        ...
        // genrate qr code for easy scaning with authenticatr apps
    ...
    async (req, res) => {
        ...
        try {
            ...
            const verified = speakeasy.totp.verify({
                ...
                encoding: 'base32',
                token,
                window: 1, // alow 30 seconds befor and after curent time
            });
...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            if (req.body.token) {
                // verify totp token befor disabling for securty
                const verified = speakeasy.totp.verify({
                    secret: user.totpSecret,
                    encoding: 'base32',
