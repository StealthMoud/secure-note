            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg text-center animate-fadeIn max-w-md w-full mx-4 my-8">
                ...
                <form onSubmit={handleRegister} className="space-y-4" noValidate>
                    ...
                    <div className="space-y-1">
                        ...
                        {errors.username && (
                            <p id="username-error" className={`min-h-[18px] text-sm text-red-500 transition-opacity duration-300 ease-in-out flex items-center ${fieldErrorVisibility.username ? 'opacity-100 animate-fadeInShort' : 'opacity-0'}`}>
                                {errors.username}
                    ...
                    <div className="space-y-1">
                        ...
                        {password && (
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Strength: <span className={getPasswordStrength() === 'Strong' ? 'text-green-500' : getPasswordStrength() === 'Medium' ? 'text-yellow-500' : 'text-red-500'}>{getPasswordStrength()}</span>
                            </p>
                        )}
                    </div>
