...
"[project]/src/services/auth.ts [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const registerUser = async (name, email, password)=>{
    return __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`${API_URL}/auth/register`, {
        name,
        email,
        password
    });
...
const loginUser = async (email, password)=>{
    const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`${API_URL}/auth/login`, {
        email,
        password
    });
...
const getCurrentUser = async (token)=>{
    const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`${API_URL}/auth/me`, {
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/auth.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
const LoginPage = ()=>{
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["loginUser"])(email, password);
            // @ts-ignore
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f05716._.js.map